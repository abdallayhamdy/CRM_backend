...
export function ShootingStarsGrid({
  ...
  return (
    <div
      ...
      className={cn(
        "group/shooting-stars relative isolate w-full overflow-hidden",
        className,
      )}
      style={
        {
    ...
    >
      {showGrid && (
        <div
          ...
          className={cn(
            ...
            "[background-image:linear-gradient(to_right,rgba(0,212,255,0.13)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,212,255,0.13)_1px,transparent_1px)]",
      ...
      {glow && (
        <motion.div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_var(--shooting-stars-glow-x)_var(--shooting-stars-glow-y),rgba(0,212,255,0.22),transparent_34%),radial-gradient(circle_at_72%_72%,rgba(168,85,247,0.16),transparent_30%)]"
        ...
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
          {staticStars.map((star, index) => (
            <motion.span
              key={index}
              className={cn(
                "absolute rounded-full bg-[#00d4ff] shadow-[0_0_12px_rgba(0,212,255,0.5)]",
