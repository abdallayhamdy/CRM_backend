...
`;
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(props: any) {
        ...
        const uniforms = (this.mouse as THREE.Mesh).material as THREE.RawShaderMaterial;
    ...
    mounted, BFECC, cursorSize, dt, isBounce, isViscous, iterationsPoisson, iterationsViscous,
