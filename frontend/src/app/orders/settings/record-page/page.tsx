...
const DEFAULT_LEFT = [
  { id: "about", label: "About this order", enabled: true, type: "property" as const },
...
const DEFAULT_RIGHT = [
  ...
  { id: "products", label: "Products", enabled: true, type: "association" as const },
]
...
export default function OrdersRecordPageSettings() {
  return (
